...
function enqueue_scripts()
{
    ...
    wp_enqueue_script('map-main', '/wp-content/plugins/map/assets/js/map-main.js', [], '1.0', true);
}
...
{
    wp_enqueue_script('build-ckeditor', '/wp-content/plugins/map/node_modules/@ckeditor/ckeditor5-build-classic/build/ckeditor.js', ['vue'], false, true);
    wp_enqueue_script('dist-ckeditor', '/wp-content/plugins/map/node_modules/@ckeditor/ckeditor5-vue/dist/ckeditor.js', ['vue'], false, true);
