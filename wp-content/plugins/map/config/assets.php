...
//    wp_enqueue_script( 'my-bootstrap', '/wp-content/plugins/map/assets/js/jquery.js', [], false, true );
//    wp_enqueue_script( 'my-bootstrap', '/wp-content/plugins/map/assets/js/bootstrap.min.js', ['my-jquery'], false, true );
